...
@Composable
@Suppress("CyclomaticComplexMethod") // Lazy
private fun Jogwheel(
   currentSpeed: () -> Float,
   bumpSpeed: (Float) -> Unit,
   setSpeed: (Float) -> Unit,
   emergencyStop: () -> Unit,
...
private const val LONG_CLICK_DURATION_MS = 250L
private const val LONG_VIBRATION_DURATION_MS = 100L
