package com.krilatokolo.wingeddriver.controller;
...
public class UsbDriverService implements UsbDriverListener {
    ...
    public UsbDriverListener listener;
    private UsbManager usbManager;
    private boolean started;
    private UsbDriverStateListener stateListener;
    private int nextDeviceId;
    public UsbDriverService(Context context) {
    ...
    public static boolean kernelSupportsXboxOne() {
        ...
        Log.d("Controller", "Kernel Version: "+kernelVersion);
        ...
        if (shouldClaimDevice(device, false)){
            ...
            if (!usbManager.hasPermission(device)) {
                ...
                try {
                    ...
                    usbManager.requestPermission(device, PendingIntent.getBroadcast(context, 0, i, intentFlags));
                } catch (SecurityException e) {
                    Toast.makeText(context, "USB prohibited", Toast.LENGTH_LONG).show();
                    if (stateListener != null) {
            ...
            if (connection == null) {
                Log.w("Controller", "Unable to open USB device: " + device.getDeviceName());
                return;
            }
