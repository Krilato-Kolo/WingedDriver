...
public class ControllerPacket {
    ...
    public static final int[] ALL_BUTOTNS = new int[] {A_FLAG, B_FLAG, X_FLAG, Y_FLAG, UP_FLAG, DOWN_FLAG, LEFT_FLAG, RIGHT_FLAG, LB_FLAG, RB_FLAG, PLAY_FLAG, BACK_FLAG, LS_CLK_FLAG, RS_CLK_FLAG, SPECIAL_BUTTON_FLAG};
